...
export class CMSServiceServiceProxy {
     ...
     * @return Success
     */
    insertOrUpdateCMSContent(input: CreateContentInput | null | undefined): Observable<CMSContent> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CMSContent>><any>_observableThrow(e);
                }
            } else
                return <Observable<CMSContent>><any>_observableThrow(response_);
        }));
    }

    protected processInsertOrUpdateCMSContent(response: HttpResponseBase): Observable<CMSContent> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CMSContent.fromJS(resultData200) : new CMSContent();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CMSContent>(<any>null);
    }
     ...
     * @return Success
     */
    getCMSContent(id: number | null | undefined): Observable<ContentDetailOutput> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ContentDetailOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<ContentDetailOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetCMSContent(response: HttpResponseBase): Observable<ContentDetailOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ContentDetailOutput.fromJS(resultData200) : new ContentDetailOutput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ContentDetailOutput>(<any>null);
    }

    /**
     * @return Success
     */
    getAll(): Observable<ListResultDtoOfCMSContentListDTO> {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<ListResultDtoOfCMSContentListDTO> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CreateContentInput implements ICreateContentInput {
    id: number | undefined;
    pageName: string;
    pageContent: string | undefined;

    constructor(data?: ICreateContentInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateContentInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateContentInput();
        result.init(data);
        return result;
    }
...
export class CMSContent implements ICMSContent {
    ...
    static fromJS(data: any): CMSContent {
        data = typeof data === 'object' ? data : {};
        let result = new CMSContent();
        result.init(data);
        return result;
    }
...
export class ContentDetailOutput implements IContentDetailOutput {
    id: number | undefined;
    pageName: string | undefined;
    pageContent: string | undefined;

    constructor(data?: IContentDetailOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ContentDetailOutput {
        data = typeof data === 'object' ? data : {};
        let result = new ContentDetailOutput();
        result.init(data);
        return result;
    }
...
export interface IContentDetailOutput {
    id: number | undefined;
    pageName: string | undefined;
    pageContent: string | undefined;
}
...
export class ListResultDtoOfCMSContentListDTO implements IListResultDtoOfCMSContentListDTO {
    items: CMSContentListDTO[] | undefined;
